...
매니페스트와 아이콘이 들어갔으니(4-5) 이제 그 길이 열려 있습니다.
TECH_SPEC 8-6 대응 1번 "설치를 데이터 보존의 조건으로 다룬다"가 아직
화면으로는 구현되지 않았습니다 — 설치를 권하는 자리가 앱 안에
없습니다. 그것이 이 방향의 다음 칸입니다.
